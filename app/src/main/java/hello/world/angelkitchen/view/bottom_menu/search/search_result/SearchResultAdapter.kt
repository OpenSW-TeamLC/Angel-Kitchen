...
class SearchResultAdapter(
    private var resultList: List<BookmarkFragmentEntity>,
    val onClickItem: (searchResultData: BookmarkFragmentEntity) -> Unit
    ...
    class MyViewHolder(val binding: RecyclerSearchResultItemBinding) :
        ...
        fun bind(
            searchResultData: BookmarkFragmentEntity,
            onClickItem: (searchResultData: BookmarkFragmentEntity) -> Unit
        ) {
